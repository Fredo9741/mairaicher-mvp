    ...
    @else
            ...
            @foreach($cart as $key => $item)
                ...
                <div class="border-b border-gray-200 p-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="text-lg font-bold text-gray-800 w-24 text-right">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <span class="text-3xl font-bold text-green-600">{{ number_format($total / 100, 2, ',', ' ') }} €</span>
            </div>
            ...
            <div class="flex justify-between space-x-4">
                <form action="{{ route('cart.clear') }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition">
                        Vider le panier
                    </button>
                </form>

                <div class="flex space-x-4">
                    <a href="{{ route('home') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition">
                        Continuer mes achats
                    </a>
                    <a href="{{ route('checkout.index') }}" class="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
                        Passer commande
                    </a>
                </div>
            </div>
